...
class _CalendarScreenState extends State<CalendarScreen>{
  ...
  double _getCompletionRate(DateTime date){
    ...
    //条件に合う要素だけを抽出
    //where(weekday)が条件
    final targetHabits=_habits.where((habit)=>habit.isTargetDay(weekday)).toList();
  ...
  Widget _buildWeekdayHeader(){
    return Row(
      ...
      children: const[
        ...
        Text("土",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.blue)),
        Text("日",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.red)),
      ],
    );
  }
